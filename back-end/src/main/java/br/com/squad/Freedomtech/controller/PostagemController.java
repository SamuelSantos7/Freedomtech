...
public class PostagemController {
	...
	public ResponseEntity<Postagem> pegarPostagemPorId(@PathVariable(value = "id_postagem") Integer id) {
	...
	public ResponseEntity<Object> deletarPostagem(@PathVariable(value = "id_postagem") Integer id) {
